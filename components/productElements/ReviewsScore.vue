...
<template>
    <div>
        <h4 v-if="reviews.edges.length" class="font-semibold text-sm text-2xl text-gray-900">
            {{ $t('messages.shop.customerReviews') }}
        </h4>
        <h4 v-else class="font-semibold text-sm text-2xl text-gray-900">
