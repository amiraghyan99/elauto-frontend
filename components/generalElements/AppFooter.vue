        ...
        <div class="container flex flex-wrap justify-between gap-12 my-24 md:gap-24">
            ...
            <div class="w-3/7 lg:w-auto">
                ...
                <div class="text-sm">
                    ...
                    <NuxtLink to="/products?orderby=rating&order=ASC&filter=rating[1]" class="py-1.5 block">
                        Top rated
                    </NuxtLink>
        ...
        <div class="container border-t">
            <div class="copywrite">
                <p class="py-4 text-xs text-center">
                    <a href="https://woonuxt.com" :title="versionInfo">
                        {{ versionInfo }}
                    </a>
                    - by
                    <a href="https://scottyzen.com" title="Scott Kennedy - Web Developer" target="_blank">
                        Scott Kennedy
                    </a>
                </p>
            </div>
