...
<template>
    <div>
        ...
        <Transition name="scale-y" mode="out-in">
            <div v-if="cart && cart.appliedCoupons" class="text-xs font-semibold uppercase">
                <div v-for="coupon in cart.appliedCoupons" :key="coupon.code" class="flex flex-wrap mt-2 flex-2">
                    <div
